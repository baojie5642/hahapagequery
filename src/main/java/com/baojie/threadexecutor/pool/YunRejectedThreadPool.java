...
public class YunRejectedThreadPool extends ThreadPoolExecutor {
	private static final Logger log = LoggerFactory.getLogger(YunRejectedThreadPool.class);
	public static final YunRejectedThreadPool instance = new YunRejectedThreadPool(4, 1024, 60, TimeUnit.SECONDS,
			new SynchronousQueue<Runnable>(), YunThreadFactory.create("YunRejectedThreadPool"), new AbortPolicy());

	public YunRejectedThreadPool(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,
